...
import ru.nsu.ccfit.arkhipov.snakes.game.GameObserver;
import ru.nsu.ccfit.arkhipov.snakes.game.GameState;
import ru.nsu.ccfit.arkhipov.snakes.game.cell.Point;
import ru.nsu.ccfit.arkhipov.snakes.game.player.Player;
import ru.nsu.ccfit.arkhipov.snakes.game.player.PlayerWithScore;
import ru.nsu.ccfit.arkhipov.snakes.game.snake.SnakeInfo;
import ru.nsu.ccfit.arkhipov.snakes.gui.controllers.View;
import ru.nsu.ccfit.arkhipov.snakes.gui.utils.GameInfoWithButton;
import ru.nsu.ccfit.arkhipov.snakes.gui.utils.PlayerColorMapper;
import ru.nsu.ccfit.arkhipov.snakes.net.MainNodeHandler;
import ru.nsu.ccfit.arkhipov.snakes.net.gamelistchecker.GameInfo;
import ru.nsu.ccfit.arkhipov.snakes.net.gamelistchecker.GameListObserver;
import ru.nsu.ccfit.arkhipov.snakes.net.node.Role;
import ru.nsu.ccfit.arkhipov.snakes.presenter.event.JoinToGameEvent;
import ru.nsu.ccfit.arkhipov.snakes.presenter.event.MoveEvent;
import ru.nsu.ccfit.arkhipov.snakes.presenter.event.UserEvent;
import ru.nsu.ccfit.arkhipov.snakes.presenter.event.UserEventType;
