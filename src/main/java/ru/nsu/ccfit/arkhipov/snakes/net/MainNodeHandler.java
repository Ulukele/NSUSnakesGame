package ru.nsu.ccfit.arkhipov.snakes.net;
...
import ru.nsu.ccfit.arkhipov.snakes.game.GameObservable;
...
import ru.nsu.ccfit.arkhipov.snakes.net.gamelistchecker.GameListChecker;
import ru.nsu.ccfit.arkhipov.snakes.net.gamelistchecker.GameListObservable;
...
import ru.nsu.ccfit.arkhipov.snakes.net.node.GameNode;
import ru.nsu.ccfit.arkhipov.snakes.net.node.MasterNode;
import ru.nsu.ccfit.arkhipov.snakes.net.node.NodeFactory;
...
public class MainNodeHandler implements NodeHandler, GameObservable, GameListObserver, GameListObservable {
    ...
    public void changeNodeRole(@NotNull Role nodeRole) {
        logger.info("Change role: " + nodeRole);
        if (config == null) {
